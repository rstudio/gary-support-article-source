...
```{r at-combination, echo = FALSE}
df <- readr::read_csv("screenreader-test-combination.csv", col_types = readr::cols())
knitr::kable(df, caption = "Tested combinations of screen readers and browsers.")
```
...
```{r menubar-shortcuts, echo = FALSE}
df <- readr::read_csv("menubar-shortcuts.csv", col_types = readr::cols())
knitr::kable(df, caption = "Menubar shortcut keys.")
```
